  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <InputGroup>
          <InputGroupAddon align="block-start">Last name</InputGroupAddon>
          <InputGroupInput
        ...
        <InputGroup className="col-span-2">
          <InputGroupAddon align="block-start">Address</InputGroupAddon>
          <InputGroupInput
        ...
        <InputGroup className="col-span-2">
          <InputGroupAddon align="block-start">Company</InputGroupAddon>
          <InputGroupInput
        ...
        <InputGroup>
          <InputGroupAddon align="block-start">Postal code</InputGroupAddon>
          <InputGroupInput
        ...
        <InputGroup>
          <InputGroupAddon align="block-start">City</InputGroupAddon>
          <InputGroupInput
