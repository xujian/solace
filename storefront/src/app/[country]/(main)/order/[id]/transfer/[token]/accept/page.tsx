  ...
  return (
    <div className="mx-auto mt-10 mb-20 flex w-2/5 flex-col items-start gap-y-4">
      ...
      <div className="flex flex-col gap-y-6">
        {success && (
          <>
            <h1 className="text-xl text-zinc-900">Order transfered!</h1>
            <p className="text-zinc-600">Order {id} has been successfully transfered to the new owner.</p>
          </>
        )}
        {!success && (
          <>
            <p className="text-zinc-600">There was an error accepting the transfer. Please try again.</p>
